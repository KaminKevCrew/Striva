...
import CustomTooltipContainer from './tool_tip_container'


class WorkoutShowMap extends React.Component {

  constructor(props) {
    super(props);
    this.route = Object.values(JSON.parse(this.props.workout.coordinates));
    this.state = {
      geojson: {},
      map: "",
      route: [],
...
export default withRouter(WorkoutShowMap);
