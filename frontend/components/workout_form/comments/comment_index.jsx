...
import { fetchWorkoutComments, removeComment } from '../../../actions/comment_actions'
...
class CommentIndex extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    if (Object.values(prevProps.comments).length !== Object.values(this.props.comments).length) {
      this.props.fetchAllWorkouts(this.props.page)
  ...
  render() {
    ...
    const actComments = this.props.workout.comment_ids.map(commentId => this.props.comments[commentId])
    let allComments = []
            ...
            <div id="modal-content">
              <section id="modal-header">
                <div className="profile-picture-small">
                  <img src={this.props.users[this.props.workout.user_id].photoUrl} />
                </div>
